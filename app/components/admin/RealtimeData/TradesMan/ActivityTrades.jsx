...
export default class ActivityUse extends Component {
    ...
    disabledDate(current) {
      const {starttime,endtimeta,tag} = this.state;
    ...
    handleSearch(e) {
        ...
        form.validateFields((err, fieldsValue) => {
            ...
            DataPublicApi.TradesChild(values)
                .then(TradesChild => {
                    this.setState({TradesChild})
                    console.log(this.state.TradesChild);
                })
                .catch(e => console.log(e));
            DataPublicApi.TradesParent(values)
                .then(TradesParent => {
                    this.setState({TradesParent})
                    console.log(this.state.TradesParent);
                 })
                    .catch(e => console.log(e));
