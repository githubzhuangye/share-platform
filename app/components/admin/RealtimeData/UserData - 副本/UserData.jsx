                    ...
                    <ul className={styles.body}>
                      <li className={styles.summarySummary}>
                        <div>
                          ...
                          <ReceiveChart dataSourceGet={userDataGet}/>
                        </div>
                      </li>
                      <li className={styles.summarySummary}>
                        <div>
                          ...
                          <ul>
                            <li>总核劵量:<span>{userDataUse.coupon}</span></li>
                            <li>总核券人数:<span>{userDataUse.user}</span></li>
                            <li>人均核券:<span>{userDataUse.avg}</span></li>
                          </ul>
                          <NuclearChart dataSourceUse={userDataUse}/>
                        </div>
                      </li>
                    </ul>
                    <ul className={styles.body}>
                      <li className={styles.summarySummary}>
                        <div>
                          ...
                          <UserChartGet dataSourceGet={userDataGet}/>
                        </div>
                      </li>
                      <li className={styles.summarySummary}>
                        <div>
                          ...
                          <UserChartUse dataSourceUse={userDataUse}/>
                        </div>
                      </li>
                    </ul>
                  </div>
