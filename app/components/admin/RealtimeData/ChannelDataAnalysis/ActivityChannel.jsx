...
@connect(
  ({realData,ChannelDataAnalysis}) => ({
    activityList: realData.activityList,
    loading: ChannelDataAnalysis.loading,
  }),
  dispatch => bindActionCreators({...realDataActionCreators,...ChannelDataAnalysisActionCreators}, dispatch)
)
...
export default class ActivityUse extends Component {
    ...
    state = {
        loading: false,
        dataSource: {coupon: "0",user: "0",avg: "0"},
        hideEle: 'none',
        chartsVal : {},
        starttime: '',
        endtime: '',
    ...
    handleSearch(e) {
        ...
        form.validateFields((err, fieldsValue) => {
            ...
            DataPublicApi.channelDataAnalysis(values)
                .then(channelDataAnalysis => {
                    this.setState({channelDataAnalysis})
                    console.log(this.state.channelDataAnalysis);
                 })
